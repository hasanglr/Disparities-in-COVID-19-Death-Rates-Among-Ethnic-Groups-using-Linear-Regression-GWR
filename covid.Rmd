...
```
#### 2.3. Local Indıcators of Spatial Autocorrelation (LISA)
...
Create a dataset including our local authorities where death rate is missing for mapping
...
map1_distribution <- tm_shape(covid7_mapping_lisa) +
...
tm_layout(legend.position = c(0.02,0.63),
   ...
   tm_credits("(a) COVID-19 Death Rates Distribution (Natural Breaks)", position=c(0,0.94), size=0.8) 
...
### 2.5.1. Shapiro-Wilk Test for Dependent Variable
...
dplyr::select(.resid)%>%
  ...
  geom_histogram()
```
Shapiro-Wilk test for LR Residuals
...
tm_layout("Map2: The LR Residuals Across England and Wales",frame = FALSE,legend.position = c("left","bottom"), legend.title.size = 0.5, legend.text.size = 0.5)

```

#### 3.1.3. Spatial Autocorrelation of LR Residuals
...
map10_asian <-  tm_shape(gwr_result2) + 
  ...
  tm_layout(legend.position = c(0.02,0.60), legend.title.size = 0.7, legend.text.size = 0.4)+
  
 tm_credits("(a) Asian %", position=c(0,0.88), size=0.7) 
...
map11_black <-  tm_shape(gwr_result2) + 
 ...
 tm_credits("(b) Black %", position=c(0,0.88), size=0.7) 


map12_white <-  tm_shape(gwr_result2) + 
  tm_fill("significant_white", title = "Legend", style = "cat", labels=c("Significant Reduction", "Not Significant", "Significant Increase"), palette = c("#e34a33", "white", "#2c7fb8")) +
  tm_shape(covid3_analysis)+
  tm_polygons(alpha=0) +
  
  tm_compass(north=0, position=c(0.85,0.85), size=1.5, show.labels= 0)+
  
  tm_scale_bar(position = c(0.67,0.05)) +
  
  tm_layout(legend.position = c(0.02,0.60), legend.title.size = 0.7, legend.text.size = 0.4)+
  
 tm_credits("(c) White %", position=c(0,0.88), size=0.7) 


map13_mixed <-  tm_shape(gwr_result2) + 
  tm_fill("significant_mixed", title = "Legend", style = "cat", labels=c("Significant Reduction", "Not Significant", "Significant Increase"), palette = c("#e34a33", "white", "#2c7fb8")) +
  tm_shape(covid3_analysis)+
  tm_polygons(alpha=0) +
 ...
 tm_credits("(d) Mixed or Multiple %", position=c(0,0.88), size=0.7) 


map14_pop_density <-  tm_shape(gwr_result2) + 
  tm_fill("significant_population_den", title = "Legend", style = "cat", labels=c("Significant Reduction", "Not Significant", "Significant Increase"), palette = c("#e34a33", "white", "#2c7fb8")) +
  tm_shape(covid3_analysis)+
  tm_polygons(alpha=0) +
  
  tm_compass(north=0, position=c(0.85,0.85), size=1.5, show.labels= 0)+
  
  tm_scale_bar(position = c(0.67,0.002), text.size=0.5) +
  
  tm_layout(legend.position = c(0.02,0.60), legend.title.size = 0.7, legend.text.size = 0.4)+
  
 tm_credits("(e) Population Density per km2", position=c(0,0.88), size=0.7) 


map15_population_65over <-  tm_shape(gwr_result2) + 
  tm_fill("significant_population_65over", title = "Legend", style = "cat", labels=c("Significant Reduction", "Not Significant", "Significant Increase"), palette = c("#e34a33", "white", "#2c7fb8")) +
  tm_shape(covid3_analysis)+
  tm_polygons(alpha=0) +
  
  tm_compass(north=0, position=c(0.85,0.85), size=1.5, show.labels= 0)+

  tm_scale_bar(position = c(0.67,0.002)) +
  
  tm_layout(legend.position = c(0.02,0.60), legend.title.size = 0.7, legend.text.size = 0.4)+
  
 tm_credits("(f) Population over 65 %", position=c(0,0.88), size=0.7) 
